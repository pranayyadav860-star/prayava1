...
var _lazy_rwqM5w = defineLazyEventHandler(() => import("./_routes/api/whatsapp/webhook.mjs"));
var _lazy_Vf3sVM = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
var findRoute = /* @__PURE__ */ (() => {
	const $0 = {
		route: "/api/whatsapp/webhook",
		handler: _lazy_rwqM5w
	}, $1 = {
		route: "/**",
		handler: _lazy_Vf3sVM
	};
	return (m, p) => {
		if (p.charCodeAt(p.length - 1) === 47) p = p.slice(0, -1) || "/";
		if (p === "/api/whatsapp/webhook") return { data: $0 };
		let s = p.split("/");
		s.length;
		return {
			data: $1,
