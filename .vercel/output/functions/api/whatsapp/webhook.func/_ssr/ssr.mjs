...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Bd_NT8CK.mjs");
...
var manifest = { "732df17f42737ebfc2c7e90dec714b5154630e1f6ade57113aa35ebef59f4588": {
	functionName: "submitLead_createServerFn_handler",
	importer: () => import("./submit-lead-DkWx6x8V.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-a7VMTo3K.mjs").then((n) => n.t),
